...
module.exports = {
    sendTokenTransaction :async (ctx) => {
        ...
        //转账金额
        let value = number * Math.pow(10,decimals);
        //代币余额
        ...
        //代币转账时返回的tokenData,tokenData必须是16进制编码数据
        let tokenData  = await myContract.methods.transfer(toaddress,value).encodeABI();
        ...
        var rawTx = {
            ...
            to: toaddress,
          //  value: value,
            data: tokenData                   //转token才会用到的一个字段
        };
